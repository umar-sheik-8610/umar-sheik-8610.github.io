...
def add_employee():
    if txtName.get() == "" or txtAge.get()=="" or txtEmail.get() == "" or txtDoj.get() == "" or comboGender.get() == "" or txtcontact.get() == "" or txtAddress.get(1.0, END) == "":
...
def update_employee():
    if txtName.get() == "" or txtAge.get() == "" or txtEmail.get() == "" or txtDoj.get() == "" or comboGender.get() == "" or txtcontact.get() == "" or txtAddress.get(
            1.0, END) == "":
        messagebox.showerror("error in Input", "Please fill the details")
        return
...
tree_frame.place(x=0, y=480, width=1420, height=520)
style = ttk.Style()
